<?php
if (!class_exists('Charitable_Gateway_BeGateway_Listener')) {

    class Charitable_Gateway_BeGateway_Listener
    {

        const QUERY_VAR = 'begateway_charitable_call';
        ...
        {
            return add_query_arg(self::QUERY_VAR, site_url('/'));
        }

        public static function get_successful_url($donation) {
          return esc_url_raw(charitable_get_permalink('donation_receipt_page', array('donation_id' => $donation->ID)));
        }

        public static function get_cancel_url($donation) {
